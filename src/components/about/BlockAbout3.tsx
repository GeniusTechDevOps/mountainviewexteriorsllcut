...
import {  type RootObject, type SectionsHomeAbout } from "../../interfaces/dbData";
...
const BlockAbout3: React.FC<Props> = ({ data, aboutSection }) => {
  return (
    <section className="flex items-center justify-center lg:h-auto pt-36">
      <div className="px-4 py-20 mx-auto max-w-7xl">
        <div className="flex flex-wrap">
          <div className="flex-1 pl-0 lg:pl-4">
            <div className="mb-12">
              <div className="relative text-center">
                <h2 className="text-5xl font-bold">{aboutSection[1].title}</h2>
            ...
            <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
              ...
              <div className="w-full p-8 text-center transition-all bg-white rounded shadow hover:shadow-lg">
                ...
                <h3 className="text-lg font-semibold text-black">Sustainability & Environment</h3>
              </div>
            </div>
          </div>
        </div>
