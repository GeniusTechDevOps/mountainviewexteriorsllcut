    ...
    <div className="relative ">
      ...
      >
        ...
        <div className="px-4 py-6 text-center">
          <i
            className="fas fa-times text-3xl cursor-pointer text-white p-2 rounded-md absolute top-12 right-0"
          ...
          <img
            ...
            alt="logo"
            className="w-[260px] mx-auto mt-10"
          />
          <div className=" pt-5">
            <Menu data={data} />
          </div>
          {
            data.redesSociales.length > 0 && (
              <div className="flex  justify-center md:justify-start gap-4 mt-4 p-5">
